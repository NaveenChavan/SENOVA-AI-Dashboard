...
- **Pipeline stepper** added: *Upload → Confirm columns → Validate rows →
  Build dashboard*, with the active step derived from **real store state**
